...
if ($request[operation] == "delete") {
    // Delete the group.
    mysqli_query("DELETE FROM groups WHERE group_id={$request[group_id]}");
    // For each member of the group, deletes the info of the resident and his booking.
    $r = mysqli_query("SELECT resident_id FROM residents_groups WHERE group_id={$request[group_id]}");
...
$r = mysqli_query("SELECT * FROM groups ORDER BY arrival");
