...
function mostrar_calendario($mes,$ano,$campo){
	...
	for ($i=0;$i<7;$i++){
		if ($i < $numero_dia){
			...
			echo "<td align=center><a href='javascript:devuelveFecha($dia_actual,$mes,$ano,'$campo')'". dame_estilo($dia_actual) .">$dia_actual</a></td>";
			$dia_actual++;
		}
	}
	echo "</tr>";
...
echo '
	...
	<tr>
	    <td colspan="2" align="center"><input type="Submit" value="[ GO TO THIS MONTH ]"></td>
	</tr>
	</table><br>
